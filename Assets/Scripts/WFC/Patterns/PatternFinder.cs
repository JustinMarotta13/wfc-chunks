...
namespace WaveFunctionCollapse
{
    public static class PatternFinder
    {
        ...
        public static Dictionary<int, PatternNeighbors> FindPossibleNeighborsForAllPatterns(IFindNeighborStrategy patternFinder, PatternDataResults patterndataResults)
        {

            return patternFinder.FindNeighbors(patterndataResults);
        }

        public static PatternNeighbors CheckNeighboursInEachDirection(int x, int y, PatternDataResults patterndataResults)
        {
            PatternNeighbors neighbours = new PatternNeighbors();
        ...
        public static void AddNeighboursToDictionary(Dictionary<int, PatternNeighbors> dictionary, int patternIndex, PatternNeighbors neighbours)
        {
            ...
            dictionary[patternIndex].AddNeighbors(neighbours);
